...
```
git clone https://github.com/chamilton614/installcentos.git
```
...
```
curl https://raw.githubusercontent.com/chamilton614/installcentos/master/install-openshift.sh | INTERACTIVE=false /bin/bash
```
...
$ export SCRIPT_REPO="https://raw.githubusercontent.com/chamilton614/installcentos/master"
